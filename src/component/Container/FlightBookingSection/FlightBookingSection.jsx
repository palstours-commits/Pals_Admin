...
import { flightBookingData } from "../../../utils/dummyMockData";

const FlightBookingSection = () => {
  const [flights, setFlights] = useState(flightBookingData);
        ...
        >
          ...
          <div className="flex justify-between items-center px-8 py-4">
            <p className="text-sm text-gray-600">
              ...
              {Math.min(startIndex + itemsPerPage, flights.length)} of{" "}
              {flights.length}
            </p>
